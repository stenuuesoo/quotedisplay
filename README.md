The main concept of this project is to generate a new quote each time the user presses the new quote button. It is responsively designed and works on all newer browsers.
